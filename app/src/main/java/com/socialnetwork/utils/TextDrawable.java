...
public class TextDrawable extends ShapeDrawable
{
	...
	public static class Builder implements IConfigBuilder, IShapeBuilder, IBuilder
	{
		...
		@Override
		public TextDrawable buildRound(String text, int color, int borderColor)
		{
			round();
		...
		@Override
		public TextDrawable build(String text, int color, int borderColor)
		{
			this.color = color;
			this.text = text;
	...
	public interface IBuilder
	{
		...
		TextDrawable build(String text, int color, int borderColor);
	}
	...
	public interface IShapeBuilder
	{
		...
		TextDrawable buildRound(String text, int color, int borderColor);
