...
public class OAuthUtils {
    ...
    public static void signGet(String apiSharedSecret, String url, List<Parameter> parameters) throws InstagramException {
        sign(OAuthUtils.REQUEST_METHOD_GET, url, apiSharedSecret, parameters);
    }

    public static void signPost(String apiSharedSecret, String url, List<Parameter> parameters) throws InstagramException {
        sign(OAuthUtils.REQUEST_METHOD_POST, url, apiSharedSecret, parameters);
    }

    public static void sign(String requestMethod, String url, String apiSharedSecret, List<Parameter> parameters) throws InstagramException {
        OAuth oauth = RequestContext.getRequestContext().getOAuth();

        String tokenSecret = oauth != null && oauth.getToken() != null
                ? oauth.getToken().getOauthToken() : "";
