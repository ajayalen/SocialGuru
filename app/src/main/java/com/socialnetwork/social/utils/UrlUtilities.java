...
package com.socialnetwork.social.utils;
...
public class UrlUtilities
{
	 ...
	 */
	public static URL buildUrl(String host, int port, String path, List<Parameter> parameters)
			throws MalformedURLException
	{
	 ...
	 * @throws MalformedURLException
	 */
	public static URL buildUrl(String host, int port, String path) throws MalformedURLException
	{
		// see: AuthUtilities.getSignature()
		// AuthUtilities.addAuthToken(parameters);
	 ...
	 * @throws MalformedURLException
	 */
	public static URL buildUrlInstagram(String host, int port, String path, List<Parameter> parameters)
			throws MalformedURLException
	{
		// see: AuthUtilities.getSignature()
		// AuthUtilities.addAuthToken(parameters);
		...
		while (iter.hasNext())
		{
			...
			if (value != null)
			{
				...
				if (!value.toString().contains("+"))
					string = UrlUtilities.encode(value.toString());
				buffer.append(string);
			}
			if (iter.hasNext())
				buffer.append("&");
	...
	public static URL buildUrlReddit(String host, String path, List<Parameter> parameters) throws MalformedURLException
	{
		// see: AuthUtilities.getSignature()
		// AuthUtilities.addAuthToken(parameters);
	...
	public static String createBuddyIconUrl(int iconFarm, int iconServer, String id)
	{
		...
		if (iconServer > 0)
		{
			iconUrl = "https://farm" + iconFarm + ".static.flickr.com/" + iconServer + "/buddyicons/" + id + ".jpg";
		}
		return iconUrl;
	}
		...
		for (int i = 0; i < encoded.length(); i++)
		{
			...
			if (focus == '*')
			{
				...
				if (focus == '+')
				{
					...
					if (focus == '%' && (i + 1) < encoded.length() && encoded.charAt(i + 1) == '7'
