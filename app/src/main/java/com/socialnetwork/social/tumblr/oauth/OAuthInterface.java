...
import com.socialnetwork.social.tumblr.REST;
import com.socialnetwork.social.tumblr.RequestContext;
import com.socialnetwork.social.tumblr.Response;
import com.socialnetwork.social.tumblr.Transport;
import com.socialnetwork.social.tumblr.Tumblr;
import com.socialnetwork.social.tumblr.TumblrException;
import com.socialnetwork.social.tumblr.User;
...
public class OAuthInterface {
    ...
    public static final String METHOD_TEST_LOGIN = "tumblr.test.login";
    ...
    public static final String URL_REQUEST_TOKEN = "https://" + Tumblr.DEFAULT_AUTH_HOST + PATH_OAUTH_REQUEST_TOKEN;
    public static final String URL_ACCESS_TOKEN = "https://" + Tumblr.DEFAULT_AUTH_HOST + PATH_OAUTH_ACCESS_TOKEN;

    public static final String PATH_REST = "";
    public static final String URL_REST = "https://" + Tumblr.DEFAULT_AUTH_HOST;
    ...
    public User testLogin()
            throws TumblrException, IOException, JSONException {
...
//        user.setUsername(name);
     ...
     */
    public OAuthToken getRequestToken(String callbackUrl) throws IOException, TumblrException {
        if (callbackUrl == null)
            callbackUrl = "oob";
        List<Parameter> parameters = new ArrayList<Parameter>();
...
//        logger.info("Getting Request Token with parameters: {}", parameters);
        ...
        if (response.containsKey(KEY_OAUTH_CALLBACK_CONFIRMED) == false
            ...
            throw new TumblrException("Error", "Invalid response: " + response);
        }
...
//        }
        ...
        return UrlUtilities.buildUrl(Tumblr.DEFAULT_AUTH_HOST, port, path, parameters);
    }
