...
import com.socialnetwork.social.tumblr.oauth.OAuthTokenParameter;
...
public abstract class Transport {
    ...
    public Response upload(String apiSharedSecret, 
            List<Parameter> parameters) throws IOException, TumblrException, SAXException {
...
//        return sendUpload(Uploader.REPLACE_PATH, parameters);
    ...
    protected abstract Response sendUpload(String path, List<Parameter> parameters) throws IOException, TumblrException, SAXException;
    
    public Response postJSON(String apiSharedSecret, 
            List<Parameter> parameters) throws IOException, JSONException, TumblrException {
