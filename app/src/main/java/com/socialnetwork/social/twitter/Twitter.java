 ...
 * Main entry point for the Twitter API.
 */
public class Twitter {
     ...
     */
    public static final String DEFAULT_API_HOST = "api.twitter.com";
     ...
     * @param transport
     */
    public Twitter(String apiKey, String sharedSecret, Transport transport) {
        setApiKey(apiKey);
