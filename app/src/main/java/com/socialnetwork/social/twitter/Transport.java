...
import com.socialnetwork.social.twitter.oauth.OAuthTokenParameter;
...
public abstract class Transport {
     ...
     * @throws JSONException
     */
    public abstract Response get(String path, List<Parameter> parameters,List<Parameter> headerParameters) throws IOException, JSONException;
    ...
    public Response upload(String apiSharedSecret,
                           List<Parameter> parameters) throws IOException, TwitterException, SAXException {
...
//        return sendUpload(Uploader.REPLACE_PATH, parameters);
    ...
    protected abstract Response sendUpload(String path, List<Parameter> parameters) throws IOException, TwitterException, SAXException;

    public Response postJSON(String apiSharedSecret,
                             List<Parameter> parameters) throws IOException, JSONException, TwitterException {
