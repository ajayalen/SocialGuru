...
public class Permissions implements Serializable {
    ...
    public int hashCode() {
        int hash = 87;
        hash += id.hashCode();
        hash += Integer.valueOf(comment).hashCode();
        hash += Integer.valueOf(addmeta).hashCode();
        hash += Boolean.valueOf(publicFlag).hashCode();
        hash += Boolean.valueOf(friendFlag).hashCode();
        hash += Boolean.valueOf(familyFlag).hashCode();
        return hash;
    }
}
