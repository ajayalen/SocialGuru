...
public final class PhotoUtils {
     ...
     */
    public static PhotoContext createPhotoContext(JSONObject data) throws JSONException {
     ...
     * @throws JSONException
     */
    public static Photo createPhoto(JSONObject photoElement)
            throws JSONException {
        Photo photo = new Photo();
     ...
     * @throws JSONException
     */
    public static PhotoList createPhotoList(JSONObject responseData)
            throws JSONException {
