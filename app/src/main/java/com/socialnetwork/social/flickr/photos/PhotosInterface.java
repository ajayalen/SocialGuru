 ...
 */
package com.socialnetwork.social.flickr.photos;
...
import com.socialnetwork.social.flickr.RequestContext;
...
import com.socialnetwork.social.utils.JSONUtils;
...
public class PhotosInterface {
    ...
    public void setDates(String photoId, Date datePosted, Date dateTaken, String dateTakenGranularity)
        ...
        if (datePosted != null) {
            parameters.add(new Parameter("date_posted", Long.valueOf(datePosted.getTime() / 1000)));
        }

        if (dateTaken != null) {
            parameters.add(new Parameter("date_taken", DATE_FORMATS.get().format(dateTaken)));
        }
