package com.socialnetwork.social.flickr.places;
...
import com.socialnetwork.social.flickr.photos.SearchParameters;
import com.socialnetwork.social.flickr.tags.Tag;
...
public class PlacesInterface {
    ...
    public PlacesList getTopPlacesList(
        ...
        if (date != null) {
            parameters.add(new Parameter("date", SearchParameters.DATE_FORMATS.get().format(date)));
        }
    ...
    public PlacesList placesForTags(
        ...
        if (minTakenDate != null) {
            parameters.add(new Parameter("min_taken_date", SearchParameters.MYSQL_DATE_FORMATS.get().format(minTakenDate)));
        }
        if (maxTakenDate != null) {
            parameters.add(new Parameter("max_taken_date", SearchParameters.MYSQL_DATE_FORMATS.get().format(maxTakenDate)));
        }
